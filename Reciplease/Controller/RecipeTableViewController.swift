...
class RecipeTableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        recipesTableView.register(UINib(nibName: "CustomRecipeViewCell", bundle: nil),
...
extension RecipeTableViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "CustomRecipeViewCell")
            as? CustomRecipeViewCell else {
