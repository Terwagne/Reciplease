...
class CoreDataTests: XCTestCase {
    ...
    func testAddRecipes_whenAFavoriteRecipeIsAdd_thenArrayisNotEmpty() {      
        ...
        RecipeEntity.add(viewContext: mockContainer.viewContext
            , recipe: Recipe.init(uri: "www", label: "Oodles of Pasta & Chicken", image: "https://www.edamam.com/web-img/364/36437d38cce55c11ad6db1f0c47775ec.jpeg", source: "www", url: "www", yield: 4, ingredientLines: ["String"], ingredients: [Ingredient.init(text: "lemon")], totalTime: 300, calories: 340.00, dietLabels: [""]))
    ...
    insertRecipeItem(into: mockContainer.viewContext)
        try? mockContainer.viewContext.save()
        RecipeEntity.fetchRecipe(label: "Oodles of Pasta & Chicken", viewContext: mockContainer.viewContext)
        XCTAssertTrue(((RecipeEntity.fetchAll(viewContext: mockContainer.viewContext).first != nil)))
    ...
    func testCheckRecipeAllreadyExist_whenEntityIsPassed_thenCheckIfEntityIsinContainer() {
        ...
        XCTAssertTrue(RecipeEntity.recipeAlreadyExist(viewContext: mockContainer.viewContext, label: "Oodles of Pasta & Chicken") )
    }
